		...
		$("#btnEp").click(function(){
			...
			if(e){
				...
				if(v1 == v2){
					...
					//数据不一致。提示错误信息
					$.messager.alert('提示信息','两次数据输入不一致','warning');
				}
			}
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							安阳工学院 | Powered by <a href="http://www.ayit.cn/">itcast.cn</a>
						</div>
					</td>
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
               <form id = "editpasswordform">
	                    ...
	                    <tr>
	                        <td>确认密码：</td>
	                        <td><input  id="txtRePass" type="Password" required="true" data-options="validType:'length[4,6]' " class="txt01 easyui-validatebox" /></td>
	                    </tr>
                	</table>
               </form>
            </div>
