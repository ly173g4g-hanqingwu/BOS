...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="userform" action="userAction_add.action" method="post" >
           <table class="table-edit"  width="95%" align="center">
				...
				<tr>
	           	...
	           	<tr><td>选择角色:</td><td colspan="3" id="roleID">
	           		<script type="text/javascript">
	           			$.post('roleAction_listajax.action',function(data){
	           				...
	           				for(var i = 0;i < data.length;i++){
	           					...
	           					$("#roleID").append('<input id="'+id+'" name="roleIds" type="checkbox" value="'+id+'"> <label for = "'+id+'">'+name+'<label>');
	           				}
